...
class ChannelServer
{
    ...
    {
        Main.debug("[ChannelList:" + 11010 + "]", msg);
    }
    ...
    public static void main() throws Exception
    {
        ...
        Main.debug("[ChannelList]", "Walked on port " + 11010 + "!");
        Main.debug("[Server]", "Server Started!");
        while(true)
        {
            ...
            {
                debug("[ChannelList] Channel List Requested.,");
                getChannels();
                ...
                debug("[ChannelList] Sent Channels");
            }
        }
    }
